...
- 임지호 :
- 현승엽 : 이 프로그램을 만드는 목적을 설명해주기 위한 여행자들의 스타일과 동기 그리고 여행자수를 베이스로 한 데이터 분석
...
### 데이터 분석
1.자연과 도시 중에 어느 것을 선호하는 가
- 자연을 선호하는 사람들이 많다.
2.새로운 지역과 익숙한 지역 중에 어느 곳을 선호하는 가
- 새로운 지역을 선호하는 사람들이 많다.
3.휴양/휴식과 체험활동 중에 어떤 것을 선호하는 가
- 둘다 하고 싶은 사람들이 꽤 많았다.(굳이 비교하자면 휴양/휴식을 원하는 사람이 조금 더 많았다고 할까나..)
4.사진촬영을 하고 싶은가 안하고 싶은가
